...
class Functions_Practice < MiniTest::Test
  ...
  def test_volume_of_sphere()
    ...
    assert_equal( 3.14, volume)
  end

  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    farenheit = farenheit_to_celsius(500)
    assert_equal(260, farenheit)
  end

  def test_odd_or_even()
   expected = "true"
   actual = odd_or_even(2)
   assert_equal(expected, actual)
 end

def test_hunger_level()
  first_hunger_level = hunger_level( 9 )
  second_hunger_level = hunger_level( 5 )
  third_hunger_level = hunger_level( 3 )
  assert_equal("Steak", first_hunger_level)
  assert_equal("Soup", second_hunger_level)
  assert_equal("Salad", third_hunger_level)
 end
end
